   ...
   */
   addEventListeners () {
    each(this.elements.items, (element, index) => {
      element.addEventListener('mouseenter', this.onMouseEnterOrLeave.bind(this)) 
      element.addEventListener('mouseleave', this.onMouseEnterOrLeave.bind(this)) 
    })
  }

  onMouseEnterOrLeave(e) {
    // console.log(e.type)
    // Math.random() * (1200 - 100) + 100
