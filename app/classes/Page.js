...
import Seperator from 'animations/Seperator'
...
export default class extends EventEmitter {
  ...
  createAnimations () {
     ...
     * Seperators.
     */
    this.animationsSeperators = mapEach(this.elements.animationsSeperators, element => {
      return new Seperator({ element })
    })

    this.animations.push(...this.animationsSeperators)
